...
ActiveRecord::Schema.define(version: 20180330171921) do
  ...
  create_table "budgetproposal_votes", force: :cascade do |t|
    t.string "voter_type"
    t.bigint "voter_id"
    t.bigint "budgetproposal_id"
    t.bigint "user_id"
    t.boolean "vote"
    t.string "comment"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["budgetproposal_id", "voter_id", "voter_type"], name: "one_vote_index", unique: true
    t.index ["budgetproposal_id"], name: "index_budgetproposal_votes_on_budgetproposal_id"
  ...
  create_table "budgetproposals", force: :cascade do |t|
    t.bigint "season_id"
    ...
    t.index ["proposer_type", "proposer_id"], name: "index_budgetproposals_on_proposer_type_and_proposer_id"
    t.index ["season_id"], name: "index_budgetproposals_on_season_id"
    t.index ["user_id"], name: "index_budgetproposals_on_user_id"
  end
  ...
  create_table "pledges", id: :serial, force: :cascade do |t|
    ...
    t.bigint "pledger_id"
    t.datetime "spent_at"
    t.integer "blockchaintransaction_id"
  ...
  add_foreign_key "budgetproposal_votes", "budgetproposals"
  add_foreign_key "budgetproposal_votes", "users"
  add_foreign_key "budgetproposals", "seasons"
